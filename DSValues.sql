insert into Producto values("PRDUC-001","Limpieza","PinoClean",20,"Unilevel",1.50,2.00),
("PRDUC-002","Juegos","Playstation",20,"Sony",300.0,350.0),
("PRDUC-003","Tecnologia","Core i7",20,"Microsoft",200.0,250.0),
("PRDUC-004","Tecnologia","Mouse",20,"Genius",20.0,25.0);
...
insert into Empleado values("0999657238","Leonardo","Pacheco",'2017-01-01','1998-20-02',"ADMIN-100","joslecar","joseleo123"),
